...
Homebrew tap for the [Ticket Fairy CLI](https://www.ticketfairy.com/).
...
1. A stable CLI release is published to npm.
2. The release workflow waits until npm's publish-time scan completes.
